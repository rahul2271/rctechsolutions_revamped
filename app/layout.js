...
export const metadata = {
  ...
  title: {
    default: "RC Tech Solutions | Web Development Company in Mohali, Punjab",
    template: "%s | RC Tech Solutions",
  },
  description:
    "RC Tech Solutions is a leading web development and digital marketing agency in Mohali, Punjab. We build fast, SEO-ready, mobile-first websites for startups, SMEs & enterprises.",
  robots: {
    index: true,
    follow: true,
    nocache: false,
  ...
  openGraph: {
    ...
    description:
      "We build luxury-grade websites, run results-driven SEO campaigns, and create brands that stand out — powered by RC Tech Solutions, Mohali.",
  ...
  twitter: {
    ...
    title: "RC Tech Solutions | Web Development Company in Mohali",
