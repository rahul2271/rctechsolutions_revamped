...
export default async function sitemap() {
  ...
  const staticPages = [
    ...
    // Local city landing pages + global outsourcing page — added Aug 2026 SEO
    // pass to close the "no local/national/global targeting" gap.
    { url: `${baseUrl}/web-development-company-in-mohali`, lastModified: SITE_LAST_DEPLOYED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/web-development-company-in-chandigarh`, lastModified: SITE_LAST_DEPLOYED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/web-development-company-in-panchkula`, lastModified: SITE_LAST_DEPLOYED, changeFrequency: "monthly", priority: 0.85 },
    { url: `${baseUrl}/hire-web-developers-india`, lastModified: SITE_LAST_DEPLOYED, changeFrequency: "monthly", priority: 0.85 },
