      ...
      <section className="border-b border-[var(--rc-wire)] rc-grid-bg">
        <div className="mx-auto max-w-5xl px-4 py-20 sm:py-24">
          <div className="flex items-center gap-2.5 mb-5">
            ...
            <span className="rc-eyebrow" style={{ color: "var(--rc-trace)" }}>Mohali, Punjab · Est. 2021</span>
          </div>
          ...
          <p className="rc-body mt-6 text-lg text-[var(--rc-ink-soft)] max-w-2xl leading-relaxed">
            ...
            and growing businesses across India who want to compete seriously online — without the overhead of a large agency.
          </p>
          ...
          <div className="grid lg:grid-cols-[2fr_1fr] gap-12 items-start">
            <div>
              ...
              <h2 className="rc-display text-3xl font-semibold text-[var(--rc-ink)] mt-2 mb-6">
                Built to fix what was broken in the Indian agency market.
              </h2>
              <div className="rc-body text-[var(--rc-ink-soft)] space-y-4 leading-relaxed text-base">
                ...
                <p>
                  ...
                  across Mohali, Chandigarh, Punjab, and the rest of India. Every project is personally overseen
                  by Rahul, and every deliverable is tested against the same quality checklist we developed in year one.
                </p>
              </div>
            </div>
