...
const PROBLEMS = [
  ...
  },
  {
    ...
    icon: "/icons/graphics-design.png",
  },
];
              ...
              >
                <div className="flex items-start justify-between gap-3 mb-4">
                  <div className="flex items-center justify-center w-10 h-10 flex-shrink-0"
                    style={{ background: "rgba(246,242,233,0.06)", border: "1px solid rgba(246,242,233,0.1)" }}>
                    <Image src={item.icon} alt="" width={22} height={22} className="opacity-90" />
                  </div>
                ...
                <span className="rc-mono text-[0.6rem] uppercase tracking-wider px-2 py-1 border inline-block mb-3 w-fit"
