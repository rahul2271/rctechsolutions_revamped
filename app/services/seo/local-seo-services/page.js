...
export const metadata = {
  ...
  title: "Local SEO Services in India | Rank in Google Maps",
  description: "Get found by customers near you. RC Tech Solutions runs Google Business Profile optimization, local citations, and review strategies to rank you in the local map pack.",
  keywords: ["local seo services India", "google business profile optimization", "local seo Mohali", "google maps ranking services", "local citations building"],
  alternates: { canonical: "https://www.rctechsolutions.com/services/seo/local-seo-services" },
  openGraph: {
    title: "Local SEO Services | RC Tech Solutions",
    description: "Get found by customers near you. RC Tech Solutions runs Google Business Profile optimization, local citations, and review strategies to rank you in the local map pack.",
    url: "https://www.rctechsolutions.com/services/seo/local-seo-services",
    siteName: "RC Tech Solutions",
    images: [{ url: "https://www.rctechsolutions.com/og/local-seo-cover.jpg", width: 1200, height: 630, alt: "Local SEO Services" }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
    ...
    title: "Local SEO Services | RC Tech Solutions",
    description: "Get found by customers near you. RC Tech Solutions runs Google Business Profile optimization, local citations, and review strategies to rank you in the local map pack.",
    images: ["https://www.rctechsolutions.com/og/local-seo-cover.jpg"],
  },
};

const faqs = [{"q":"How long until I see local SEO results?","a":"Most businesses see initial Google Business Profile improvements within 2-4 weeks, with map pack ranking gains typically visible in 8-12 weeks."},{"q":"Do I need a physical address for local SEO?","a":"For Google Business Profile, yes — though service-area businesses without a public storefront can still use a service-area setup."},{"q":"Can you help with negative reviews?","a":"We can help craft professional responses to negative reviews and build a steady stream of positive reviews to balance your overall rating."}];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Local SEO Services", item: "https://www.rctechsolutions.com/services/seo/local-seo-services" },
  ],
};

const includedItems = [{"title":"Google Business Profile optimization","desc":"Complete, keyword-optimised profile setup with regular posting cadence."},{"title":"Local citation building","desc":"Consistent NAP (name, address, phone) listings across major directories."},{"title":"Review generation strategy","desc":"Systems to ethically encourage more 5-star reviews from happy customers."},{"title":"Local keyword targeting","desc":"On-page optimization around 'near me' and city-specific search terms."},{"title":"Local landing pages","desc":"Dedicated pages for each location you serve, built to rank individually."},{"title":"Monthly local ranking reports","desc":"Track your map pack position for your target keywords over time."}];
const processSteps = [{"title":"Local audit","desc":"We assess your current Google Business Profile and citation consistency."},{"title":"Profile optimization","desc":"Categories, descriptions, photos, and posts are optimised."},{"title":"Citation cleanup & building","desc":"Inconsistent listings are fixed and new citations are built."},{"title":"Ongoing management","desc":"Monthly posting, review monitoring, and ranking reports."}];
      ...
      <div className="min-h-screen" style={{ background: "var(--rc-paper)" }}>
        <nav className="border-b border-[var(--rc-wire)]" aria-label="Breadcrumb">
          <div className="mx-auto max-w-6xl px-4 py-3 rc-mono text-[0.65rem] text-[rgba(42,45,53,0.6)] flex flex-wrap items-center gap-1.5">
            ...
            <span>/</span>
            <span className="text-[var(--rc-ink-soft)]">Local SEO Services</span>
          </div>
        </nav>
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20 grid lg:grid-cols-[1.2fr_1fr] gap-10 items-start">
            <div>
              ...
              <p className="rc-body mt-5 text-base sm:text-lg text-[rgba(246,242,233,0.65)] leading-relaxed max-w-xl">
                If your customers search 'near me', local SEO is what gets you found. We optimise your Google Business Profile, citations, and reviews to win the local map pack.
              </p>
            ...
            <div className="lg:sticky lg:top-24">
              <ServiceLeadForm
                ...
                heading="Get a free local SEO assessment"
                subheading="Tell us your business location and category — we'll check your current local visibility."
              />
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-[1.6fr_1fr] gap-12">
            <div>
              <section>
                ...
                <p className="rc-body text-[var(--rc-ink-soft)] mb-6 leading-relaxed">Local SEO is a different game from organic SEO — it's about proximity, relevance, and trust signals specific to your area.</p>
