            ...
            {currentIndustries.map((ind) => {
              ...
              return (
                ...
                >
                  ...
                  {ind.image && !ind.image.endsWith('.svg') && (
                    <div className="relative w-full h-28 mb-4 rounded-xl overflow-hidden">
                      <Image src={ind.image} alt={`${ind.title} industry solutions`} fill className="object-cover transition-transform md:group-hover:scale-105" sizes="(max-width:768px) 90vw, 260px" />
                      <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, rgba(11,14,20,0) 40%, rgba(11,14,20,0.55) 100%)' }} />
                    </div>
                  )}
