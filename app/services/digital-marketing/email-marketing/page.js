...
export const metadata = {
  ...
  title: "Email Marketing Services in India",
  description: "Turn your email list into a reliable revenue channel. RC Tech Solutions builds automated email flows and campaigns that nurture leads and drive repeat sales.",
  keywords: ["email marketing services India", "email automation company Mohali", "newsletter marketing services", "klaviyo mailchimp setup India"],
  alternates: { canonical: "https://www.rctechsolutions.com/services/digital-marketing/email-marketing" },
  openGraph: {
    title: "Email Marketing Services | RC Tech Solutions",
    description: "Turn your email list into a reliable revenue channel. RC Tech Solutions builds automated email flows and campaigns that nurture leads and drive repeat sales.",
    url: "https://www.rctechsolutions.com/services/digital-marketing/email-marketing",
    siteName: "RC Tech Solutions",
    images: [{ url: "https://www.rctechsolutions.com/og/email-marketing-cover.jpg", width: 1200, height: 630, alt: "Email Marketing Services" }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
    ...
    title: "Email Marketing Services | RC Tech Solutions",
    description: "Turn your email list into a reliable revenue channel. RC Tech Solutions builds automated email flows and campaigns that nurture leads and drive repeat sales.",
    images: ["https://www.rctechsolutions.com/og/email-marketing-cover.jpg"],
  },
};

const faqs = [{"q":"What email platforms do you work with?","a":"We primarily work with Mailchimp, Klaviyo, and Brevo, and can recommend the best fit based on your business size and e-commerce platform."},{"q":"How big does my list need to be to start?","a":"There's no minimum — in fact, setting up automation early means your list grows alongside a working revenue system from day one."},{"q":"Can you write the email copy too?","a":"Yes, copywriting is included in every email marketing engagement, tailored to your brand voice."}];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Email Marketing Services", item: "https://www.rctechsolutions.com/services/digital-marketing/email-marketing" },
  ],
};

const includedItems = [{"title":"Welcome & onboarding flows","desc":"Automated sequences that introduce new subscribers to your brand."},{"title":"Abandoned cart recovery","desc":"Automated emails that bring back customers who didn't complete checkout."},{"title":"Newsletter campaigns","desc":"Regular, engaging newsletters that keep your brand top of mind."},{"title":"List segmentation","desc":"Targeted emails based on customer behavior, not generic blasts."},{"title":"A/B testing","desc":"Subject lines and content tested to continuously improve open rates."},{"title":"Platform setup & migration","desc":"Mailchimp, Klaviyo, or Brevo set up or migrated cleanly."}];
const processSteps = [{"title":"Audit & strategy","desc":"We review your current list health and define a flow strategy."},{"title":"Design & copywriting","desc":"On-brand templates and persuasive copy are created."},{"title":"Automation setup","desc":"Flows are built, tested, and connected to your store or CRM."},{"title":"Monitor & optimise","desc":"Performance tracked monthly with ongoing A/B testing."}];
      ...
      <div className="min-h-screen" style={{ background: "var(--rc-paper)" }}>
        <nav className="border-b border-[var(--rc-wire)]" aria-label="Breadcrumb">
          <div className="mx-auto max-w-6xl px-4 py-3 rc-mono text-[0.65rem] text-[rgba(42,45,53,0.6)] flex flex-wrap items-center gap-1.5">
            ...
            <span>/</span>
            <span className="text-[var(--rc-ink-soft)]">Email Marketing Services</span>
          </div>
        </nav>
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20 grid lg:grid-cols-[1.2fr_1fr] gap-10 items-start">
            <div>
              ...
              <p className="rc-body mt-5 text-base sm:text-lg text-[rgba(246,242,233,0.65)] leading-relaxed max-w-xl">
                Email remains one of the highest-ROI marketing channels — when it's done right. We design, write, and automate email flows that actually get opened and clicked.
              </p>
            ...
            <div className="lg:sticky lg:top-24">
              <ServiceLeadForm
                serviceName="Email Marketing Services"
                heading="Get a free email strategy session"
                subheading="Tell us about your current list size and goals — we'll suggest a starting strategy."
              />
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-[1.6fr_1fr] gap-12">
            <div>
              <section>
                ...
                <p className="rc-body text-[var(--rc-ink-soft)] mb-6 leading-relaxed">From welcome sequences to abandoned cart flows, we build the automations that keep working long after setup.</p>
