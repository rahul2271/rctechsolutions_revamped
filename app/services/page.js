...
export const metadata = {
  ...
  description:
    'RC Tech Solutions offers web development, mobile apps, SEO, digital marketing, branding, AI solutions, cloud integration, and DevOps services for startups and businesses across India.',
  keywords: [
  ...
  openGraph: {
    title: 'Services | RC Tech Solutions — Mohali, Punjab',
    description: 'Eight services. One quality bar. From web development to AI-powered solutions — built for Indian startups and businesses.',
