...
export const metadata = {
  ...
  title: "Web Development Company in Mohali, India | Next.js Agency Serving USA, UK & Worldwide",
  description:
    "RC Tech Solutions builds fast, SEO-engineered websites and runs growth campaigns for startups, SMEs, and enterprises across India — and for international clients in the USA, UK, Canada & Australia. Based in Mohali, Punjab. 50+ projects shipped. 90+ PageSpeed guaranteed.",
  keywords: [
    // Local-intent (Mohali/Chandigarh tricity — where "near me" searches convert)
    ...
    // Global/remote-intent (what USA/UK/Canada founders actually search)
    "remote web development agency India",
    "hire Next.js developer India",
    "outsource web development India for startups",
    "Next.js development agency for startups",
    "offshore web development company India",
    "affordable website development agency for small business USA",
...
const schemaWebsite = {
  ...
  url: "https://www.rctechsolutions.com/",
  description: "Web development company in Mohali, India building fast, SEO-ready websites for startups, SMEs and enterprises across India, the USA, UK, Canada and Australia.",
...
const schemaOrganization = {
  ...
  description: "RC Tech Solutions is a web development and digital marketing agency based in Mohali, Punjab, India. We build fast, SEO-engineered websites and run growth campaigns for startups and enterprises across India, the USA, UK, Canada and Australia.",
  foundingDate: "2021",
  ...
  // FIX (Aug 2026 SEO pass): areaServed only listed Mohali/Chandigarh/Punjab/
  // India — no structured signal anywhere that the business also takes on
  // international projects, despite the "hire-web-developers-india" page
  // and existing client work saying otherwise. Adding the international
  // markets here too, alongside (not instead of) the local ones.
  areaServed: [
...
const schemaFAQ = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Do you only work with clients in India, or can you take on international projects?", acceptedAnswer: { "@type": "Answer", text: "We're based in Mohali, India, but the majority of our development stack (Next.js, React, NestJS) is built remote-first, and we regularly work with clients in the USA, UK, Canada, and Australia — communicating async and over overlapping-hours calls to fit your time zone, with the same fixed-price, fixed-timeline process." } },
  ],
};
