...
"[project]/app/api/blogs/comments/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const res = await fetch(`${WP_URL}/wp-json/wp/v2/comments?post=${postId}&order=asc&orderby=date&per_page=100&status=approve`, {
            headers: wpHeaders,
            next: {
                revalidate: 60
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0rv2wjs._.js.map